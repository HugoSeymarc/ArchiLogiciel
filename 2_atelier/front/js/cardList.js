...
const URL_API_GET = "http://127.0.0.1:8080/cards/" + userID;
let context = {
    method: 'GET'
};
...
function callback(data) {
    ...
    for (const card of data) {
        ...
        card.img_src = "https://static.fnac-static.com/multimedia/Images/8F/8F/7D/66/6716815-1505-1540-1/tsp20171122191008/Lego-lgtob12b-lego-batman-movie-lampe-torche-batman.jpg"
